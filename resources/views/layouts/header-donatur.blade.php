  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse"style="background-color: #ffffff;">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4 rounded">
        <a href="beranda-donatur" class="list-group-item list-group-item-action py-2 ripple warna" aria-current="true">
    ...
    <div class="container-fluid vh-100 d-flex justify-content-center align-items-center mt-5">
        <p class="text-primary fw-bold m-0"><a href="home" class="list-group-item warnus"><i class="bi bi-box-arrow-left me-2"></i>Keluar</a></p>
    </div>
  </nav>
  <!-- Sidebar -->
    ...
    <div class="container-fluid">
      ...
      <ul class="navbar-nav ms-auto d-flex flex-row">
        ...
        <li class="nav-item dropdown">
          ...
          <i class="bi bi-person-circle me-2 warnus"></i><span class="warnus">Welcome, Donatur</span>
          </a>
        </li>
      </ul>
    </div>
