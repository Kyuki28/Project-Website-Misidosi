...
<style>
  ...
  <figure>
      <blockquote class="blockquote mt-3 ms-3">
        <p class="warnus fw-bold">TAMBAH DONASI</p>
    </blockquote>
...
@endif
    ...
    <div class="card">
      ...
      <div class="card-body">
        <!-- Start Form -->
        <form id="bookingForm" action="{{ route('simpan-donasi') }}" method="post" class="needs-validation" novalidate autocomplete="off" enctype="multipart/form-data">
          @csrf
          <!-- Start Input Name -->
